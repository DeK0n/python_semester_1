...
weight_gramm_fractional = weight_total_in_gramms - weight_kilos_int*1000 # "-" is minus sign
# weight_gramm_fractional = weight_total_in_gramms % (weight_kilos_int*1000) #also works with "%" modulo operation (finds remainder)
print("The weight in modern units is: ")
print(f"{weight_kilos_int:.0f} kg and {weight_gramm_fractional: .2f} g")
