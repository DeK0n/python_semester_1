...
# (chief editor Aki Hyyppä) and Compartment No. 6 (author Rosa Liksom, 192 pages). Print out all information 
...
# For example, the initializer of electric cars receives the registration number, maximum speed and battery 
# capacity as its parameter. It calls the initializer of the base class to set the first two properties and then 
# sets its capacity. Write a main program where you create one electric car (ABC-15, 180 km/h, 52.5 kWh) and one 
# gasoline car (ACD-123, 165 km/h, 32.3 l). Select speeds for both cars, make them drive for three hours and print 
# out the values of their kilometer counters.